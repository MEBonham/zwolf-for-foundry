...
Hooks.once('init', async function() {
  ...
  CONFIG.Combat.initiative = {
    formula: "3d12kl2kh1 + @saves.ref.value",
    decimals: 2
  };
  ...
  Actors.registerSheet("zwolf", ZWolfActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("zwolf", ZWolfItemSheet, { makeDefault: true });
